...
fun ReportScreen(
    ...
    LazyColumn(
        ...
        item {
            Column {
                Text("Thị trường", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.Bold)
        ...
        item {
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text("Tỷ giá ngoại tệ (VCB)", fontWeight = FontWeight.Bold)
                        ...
                        marketState.rates.forEach { rate ->
                            Row(
                                ...
                                Text(
                                    ...
                                    color = if (rate.changePercent >= 0) Color(0xFF4CAF50) else Color(0xFFF44336)
                                )
                            }
                    ...
                    Text("Giá vàng hôm nay", fontWeight = FontWeight.Bold)
                    Spacer(modifier = Modifier.height(4.dp))
                    ...
                    Text("Quy đổi nhanh", fontWeight = FontWeight.Bold)
                    Spacer(modifier = Modifier.height(8.dp))
        ...
        // ========== BÁO CÁO TÀI CHÍNH (giữ nguyên logic cũ) ==========
        item {
            Text("Báo cáo tài chính", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.Bold)
        }
        ...
        item {
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Spacer(modifier = Modifier.height(12.dp))
                    Text("Tổng thu: ${currencyFormatter.format(totalIncome)}", color = Color(0xFF4CAF50))
                    Text("Tổng chi: ${currencyFormatter.format(totalExpense)}", color = Color(0xFFF44336))
        ...
        item {
            Text("Chi tiết giao dịch", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
        }
